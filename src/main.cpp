      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          double smallest_weight = 1.0;
            ...
            if (particles[i].weight < smallest_weight) {
              smallest_weight = particles[i].weight;
            }
			      weight_sum += particles[i].weight;
		      }

		      //cout << "highest w " << highest_weight << endl;
          //cout << "smallest w " << smallest_weight << endl;
          //cout << "average w " << weight_sum / num_particles << endl << endl;
